...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\gpsnitter on
     Windows, /home/user/dev/gpsnitter on Linux) in a file named
     gpsnitter@mozillamessaging.com and copy that file to
